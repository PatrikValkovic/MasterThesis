...
\begin{figure}[ht!]
    ...
    \caption[Fitness of various mutation operators in real--coded evolutionary algorithms]{Fitness of real--coded evolutionary algorithm with various mutation operators. Measured on \acrshort{acc:bbob} functions $f_{19}$ and $f_{24}$ (available in attachment). Algorithm used hyperparameters specified in Table \ref{tab:esmutationhyperparmarameters}.}
