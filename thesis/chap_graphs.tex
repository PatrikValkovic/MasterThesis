...
\begin{figure}[ht!]
    ...
    \caption[Running times of GA depending on problem size]{Genetic algorithm running time depending on problem size. \todo{Dopsat popisek.}}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \caption[Fitness of genetic algorithm]{Fitness of genetic algorithm on 3SAT problem.\todo{Dopsat popisek.}}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \caption[Fitness of genetic algorithm with elitism]{Fitness of genetic algorithm with elitism on 3SAT problem.\todo{Dopsat popisek.}}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \caption[Fitness scale operators running time]{Running times of fitness scale operators. \todo{Dopsat popisek.}}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \caption[Running times of select operators]{Running times of select operators. \todo{Dopsat popisek.}}
\end{figure}
