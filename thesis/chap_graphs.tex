...
All the algorithms were run with hyperparameters given in appendix \ref{chap:hyperparameters}. Each configuration ran a hundred times and the plotted values are mean of specified metric. Results in higher resolution are in the attachment.
