...
p.add_argument("--neigh_size", type=float, help="Neighbrhood size")
args, _ = p.parse_known_args()
if int(args.neigh_size) == args.neigh_size:
    args.neigh_size = int(args.neigh_size)
...
with WandbReporter({'config': {
    ...
    'bbob_dim': args.dim,
    'alg_group': 'pso',
    'pso.neigh': PSO.neighborhood.Nearest.__name__,
    ...
    try:
        alg = PSO.PSO(
            ...
            PSO.neighborhood.Nearest(args.neigh_size),
