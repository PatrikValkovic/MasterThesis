...
p.add_argument("--clauses", type=str, help="Number of literals")
...
args.clauses = list(map(int, args.clauses.split(',')))
...
for psize, clauses in itertools.product(args.popsize, args.clauses):
    ...
    for i in range(args.repeat):
        ...
        print(f"{time.asctime()}\tSAT clausecaunt {literals}:{clauses} with population {psize}, running for {i}")
